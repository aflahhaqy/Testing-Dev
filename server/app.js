...
app.get("/groups-items", authentication, Controller.getGroupsWithItems);
app.post("/applications/:id/scoring", authentication, Controller.submitScoring);
app.get("/applications/:id/score", authentication, Controller.getApplicationScore);
